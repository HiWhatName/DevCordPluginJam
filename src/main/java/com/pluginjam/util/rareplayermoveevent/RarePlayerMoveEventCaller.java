package com.pluginjam.util.rareplayermoveevent;

import com.pluginjam.util.timer.ConditionedTimer;
import com.pluginjam.util.timer.Timer;
...
public class RarePlayerMoveEventCaller implements Timer {
    ...
    /**
     * @param plugin The plugin to register the listener to that this class uses.
     * @param checkInterval The interval in Minecraft ticks (1 tick = 0.05 seconds) where the event can be called.
     */
